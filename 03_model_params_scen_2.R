...
###--------------------------------------------------------------------------
# THIS IS SCENARIO 2: all household interventions, no treatment
####-------------------------------------------------------------------------
#############################################################################
...
treat_prob <- 0.001 # probability of getting treated
cure_prob <- 0.5 # probability of receiving radical cure (receiving standard cure is 1-cure_prob)
