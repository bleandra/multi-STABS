...
###--------------------------------------------------------------------------
# THIS IS SCENARIO 4: all household interventions, standard treatment for everyone
####-------------------------------------------------------------------------
#############################################################################
...
cure_prob <- 0.001 # probability of receiving radical cure (receiving standard cure is 1-cure_prob)
